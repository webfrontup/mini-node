...
let school = {name:'yyccQQu',age:{age:1}}
let newSchool =Object.assign(school)
school.age.age =2;
console.log(newSchool)

// 实现一个深拷贝 不支持函数拷贝
let school = {name:'yyccQQu',age:{age:1},fn:function(){}}
let result = JSON.parse(JSON.stringify(school));
school.age.age =2;
console.log(result);

// 递归拷贝 保证如果是对象 生成一个空对象 将值放到对象内 
let school = {name:'yyccQQu',age:{age:1},fn:function(){},arr:[1,2,3]}
