...
let result = Array.from({ 0: 1, 1: 2, length: 3 }); //[1, 2, undefined]
// Array.from = Array.prototype.slice.call(arguments,0)
let result = Array.prototype.slice.call({0:1,1:2,length:2},0); //[1, 2]
...
let flags = [1, 1, 1].every(function (item, index) {
    console.log('11111');
    return item === 1
});
console.log(flags);
